...
class Command(BaseCommand):
    help = "Create fake data for relational models (Company, Project, Invoice, Time)."
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            type=int,
            default=3,
            help="Number of projects per company (default: 3)",
        )
        parser.add_argument(
            "--invoices",
            type=int,
    ...
    def handle(self, *args, **options):
        ...
        if model_name.lower() == "company":
            from db.models import Company, Project, Invoice, Time
            ...
            self.stdout.write(
                self.style.SUCCESS(
                    ...
                    f"{num_projects} Project(s), {num_invoices} Invoice(s) per project, "
