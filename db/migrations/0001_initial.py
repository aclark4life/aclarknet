    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ein', models.CharField(blank=True, max_length=300, null=True, verbose_name='EIN')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(blank=True, default='aclark@aclark.net', max_length=254, null=True)),
                ('company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='db.company')),
            ],
            options={
                'ordering': ['name'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='db.client')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('github_access_token', models.CharField(blank=True, max_length=150, null=True)),
                ('notes', models.ManyToManyField(blank=True, to='db.note')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('github_project', models.CharField(blank=True, max_length=300, null=True, verbose_name='GitHub Project')),
                ('github_repository', models.CharField(blank=True, max_length=300, null=True, verbose_name='GitHub Repository')),
                ('client', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='db.client')),
        ...
        migrations.AddField(
            model_name='project',
            name='task',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='db.task'),
        ),
        migrations.AddField(
            model_name='invoice',
            name='task',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('net', models.DecimalField(blank=True, decimal_places=2, max_digits=12, null=True)),
                ('client', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='db.client')),
                ('invoice', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='times', to='db.invoice')),
                ('notes', models.ManyToManyField(blank=True, to='db.note')),
                ('project', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='db.project')),
                ('task', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='db.task')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invoice', models.ForeignKey(blank=True, limit_choices_to={'archived': False}, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='time_entries', to='db.invoice')),
                ('task', models.ForeignKey(limit_choices_to={'archived': False}, on_delete=django.db.models.deletion.CASCADE, related_name='time_entries', to='db.task')),
                ('user', models.ForeignKey(limit_choices_to={'is_active': True}, on_delete=django.db.models.deletion.CASCADE, related_name='time_entries', to=settings.AUTH_USER_MODEL)),
            ],
            options={
