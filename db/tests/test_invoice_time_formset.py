...
from db.models import Invoice, Project, Time
...
class InvoiceTimeEntryFormsetTests(TestCase):
    ...
    def test_formset_saves_new_time_entries(self):
        ...
        self.assertTrue(time_formset.is_valid(), f"Formset errors: {time_formset.errors}")
    ...
    def test_formset_updates_existing_time_entries(self):
        ...
        self.assertEqual(time_formset.forms[0].cleaned_data['description'], 'Updated description')
