...
from aclarknet.wagtail_urls.admin import collections as wagtailadmin_collections_urls
from aclarknet.wagtail_urls.admin import (
    editing_sessions as wagtailadmin_editing_sessions_urls,
)
from aclarknet.wagtail_urls.admin import pages as wagtailadmin_pages_urls
from aclarknet.wagtail_urls.admin import workflows as wagtailadmin_workflows_urls
...
urlpatterns = [
    ...
    path(
        "choose-page/<str:parent_page_id>/",
