...
INSTALLED_APPS = [
    "home",
    "search",
    "aclarknet.apps.WagtailFormsConfig",
    "aclarknet.apps.WagtailRedirectsConfig",
    "aclarknet.apps.WagtailEmbedsConfig",
    "wagtail.sites",
    "aclarknet.apps.WagtailUsersConfig",
    "wagtail.snippets",
    "aclarknet.apps.WagtailDocsConfig",
    "aclarknet.apps.WagtailImagesConfig",
    "aclarknet.apps.WagtailSearchConfig",
    "aclarknet.apps.WagtailConfig",
    "modelcluster",
    "aclarknet.apps.TaggitConfig",
    "django_filters",
    "aclarknet.apps.AdminConfig",
    "aclarknet.apps.AuthConfig",
    "aclarknet.apps.ContentTypesConfig",
    ...
    "db",
    "aclarknet.apps.WagtailAdminConfig",
    "django_extensions",
    "cms",
    "webpack_boilerplate",
    "crispy_forms",
...
MIGRATION_MODULES = {
    ...
    "wagtailembeds": "aclarknet.migrations.wagtailembeds",
