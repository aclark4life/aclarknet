:title: Pillow 2-3-0 is Out
:date: 2014-01-01
:slug: pillow-2-3-0-is-out
:tags: Pillow, Python
:source: blog-2017
:status: draft
...
Additionally, we've forked the PIL handbook and have included it with our documentation here: https://pillow.readthedocs.io. Special thanks to Stephen Johnson AKA "irksep" for working on this.

Distributions
-------------

Lastly, I'm very grateful to Christopher Gohlke for producing Windows Egg, Exe, and Wheel distributions to accompany each source release. I suspect Christopher will produce his 2.3.0 distributions any second now at which point I will upload them to PyPI via `twine <https://pypi.org/project/twine>`_.
