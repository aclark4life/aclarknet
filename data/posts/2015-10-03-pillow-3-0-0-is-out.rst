:title: Pillow 3-0-0 is Out
:date: 2015-10-03
:slug: pillow-3-0-0-is-out
:tags: Pillow, Python
:source: blog-2017
:status: draft
...
- `LibJpeg and Zlib are Required by Default <https://pillow.readthedocs.io/en/3.0.x/releasenotes/3.0.0.html#libjpeg-and-zlib-are-required-by-default>`_

- `Deprecated Methods <https://pillow.readthedocs.io/en/3.0.x/releasenotes/3.0.0.html#deprecated-methods>`_
...
- https://pillow.readthedocs.io/en/3.0.x/releasenotes/3.0.0.html
