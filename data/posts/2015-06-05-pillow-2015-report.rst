...
- Over `5.5 million PyPI downloads <https://pypi.org/project/vanity>`_.

  - About `36 distributions <https://pypi.org/project/Pillow/2.8.1#downloads>`_ uploaded with each release, including Windows Eggs/Exes/Wheels, OS X Wheels and source distributions.
...
- https://pillow.readthedocs.io/installation.html
