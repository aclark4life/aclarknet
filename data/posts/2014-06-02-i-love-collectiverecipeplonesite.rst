:title: I love collective.recipe.plonesite!
:date: 2014-06-02
...
extends-cache = /Users/aclark/Developer/extends-cache
 ...
 , the entire process only takes a few seconds (except for when I  run into trouble with setuptools . I should probably start doing  virtualenv  --no-setuptools . Perhaps this can be made default?)
...
$ bin/plone debug
 ...
 However at this point there is no Plone site object in the database. One could easily create a Plone site through-the-web, but why bother when  collective.recipe.plonesite  exists:
